...
export async function POST(request: NextRequest) {
    try {
        ...
        // Update product averageRating and reviewCount once approved (manual for now)
        // In future: Auto-approve or add admin panel
...
// PUT - Approve a review (admin only - add auth later)
export async function PUT(request: NextRequest) {
    try {
        ...
        // Always update product stats after any status change
        // Fetch ALL currently approved reviews for this product
        ...
        await Product.findByIdAndUpdate(review.productId, {
            averageRating: parseFloat(avgRating.toFixed(1)), // Ensure consistent 1 decimal place
